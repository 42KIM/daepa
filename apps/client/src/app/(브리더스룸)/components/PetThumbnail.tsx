  ...
  return (
    <div className="relative aspect-square w-full overflow-hidden rounded-2xl bg-gray-100 text-center text-gray-400 transition-colors hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-700">
      {imageUrl ? (
        ...
        <div className="relative flex aspect-square w-full items-center justify-center overflow-hidden rounded-lg bg-gray-100 text-center text-[12px] text-gray-400 transition-colors hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-700">
          준비중
        </div>
      )}
    </div>
