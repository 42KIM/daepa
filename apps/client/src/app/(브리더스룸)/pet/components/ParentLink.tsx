            ...
            <div className="flex-1">
                ...
                <div className="flex flex-col items-center gap-2">
                    ...
                    >
                        {editable ? (
                            <Search
                                className="absolute left-1/2 top-1/2 h-6 w-6 -translate-x-1/2 -translate-y-1/2 text-gray-400"/>
                        ) : (
    ...
    if ("hiddenStatus" in data && data.hiddenStatus === PetHiddenStatusDtoHiddenStatus.SECRET) {
        return (
            <div className="flex-1">
                ...
                <div className="flex flex-col items-center gap-2">
                    <div
                        className="relative aspect-square w-full overflow-hidden rounded-2xl bg-gray-200/50 dark:bg-gray-700/50">
            ...
            <div className="group relative block h-full w-full transition-opacity hover:opacity-95">
                ...
                >
                    <div className="relative w-full">
                        ...
                        {isMyPet ? (
                            <div
                                className="absolute left-2 top-2 flex items-center gap-1.5 rounded-full bg-blue-100 px-2.5 py-1">
